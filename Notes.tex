...
\begin{itemize}
    ...
    \item \textbf{Definition 1.4.1} \emph{Vector subspaces} \\
        ...
        \[
            \vec{u}, \vec{v} \in U \ \math{and} \ \lambda \in F \implies
            \vec{u} + \vec{v} \in U \ \math{and} \ \lambda \vec{u} \in U
        \]
...
\begin{itemize}
    ...
    \item \textbf{Notation} \\
        ...
        to be the subspace $\langle U \cup W \rangle$ of $V$ generated by $U$ and $W$ together.
...
\begin{itemize}
    ...
    \item \textbf{Definition 2.3.3} \emph{Representation of a vector with respect to a basis} \\
...
\begin{itemize}
    ...
    \item \emph{Homomorphism} \\
        Where $A, B$ are groups or rings: \\
        A homomorphism is a mapping $f : A \to B$ where the following hold:
        \begin{align*}{}
            f(x + y) & = f(x) + f(y) \\
            f(xy)    & = f(x) f(y)
        \end{align*}
