...
\begin{itemize}
    ...
    \item \textbf{Definition 1.4.1} \emph{Vector subspaces} \\
        ...
        \emph{subspace} if $U$ contains $\mathbf{0}$ and
        \[
            \mathbf{u}, \mathbf{v} \in U \ \math{and} \ \lambda \in F \implies
            \mathbf{u} + \mathbf{v} \in U \ \math{and} \ \lambda \mathbf{u} \in U
        \]
    ...
    \item \textbf{Proposition 1.4.5} Generating a vector subspace from a subset \\
        ...
        $\alpha_1 \mathbf{v}_1 + \cdots + \alpha_r \mathbf{v}_r$ with
        $\alpha_1, \ldots, \alpha_r \in F$ and $\mathbf{v}_1, \ldots, \mathbf{v}_r \in T$,
        together with $\mathbf{0}$ in the case $T = \emptyset$.
...
\begin{itemize}
    ...
    \item \textbf{Theorem 1.5.16} (Useful variant on Linear combinations of basis elements) \\
        Let $F$ be a field, $V$ an $F$-vector space, and ${(\mathbf{v}_i)}_{i\in I}$
        a family of vectors from the vector space $V$.
        The following are equivalent:
        \begin{enumerate}
            \item The family $(\mathbf{v}_i){i\in I}$ is a basis for $V$;
            \item For each vector $\mathbf{v} \in V$ there is precisely one family
...
\begin{itemize}
    ...
    \item \textbf{Definition 1.7.1} \emph{Linear mapping} \\
        ...
        if for all $\mathbf{v}_1, \mathbf{v}_2 \in V$ and $\lambda \in F$ we have
        \begin{align*}{}
...
\begin{itemize}
    ...
    \item \textbf{Definition} \emph{Idempotent} \\
...
\begin{itemize}
    ...
    \item \textbf{Theorem 2.2.5} Transformation of a matrix into Smith-Normal form \\
        ...
        $P$ and $Q$ such that $PAQ$ is a matrix in Smith Normal Form and $Q$ such that $PAQ$
    ...
    \item \textbf{Definition 2.2.8} \emph{Full rank} \\
        Whenever the rank of a matrix is equal to the number of rows (or columns --- whichever
        is smaller), it has \emph{full rank}.
...
\begin{itemize}
    ...
    \item \textbf{Definition 3.5.3} \\
        ...
        A subset $Z \subseteq X$ containing precisely one element from each equivalence class
        is called a \emph{system of representatives} for the equivalence relation.
...
\begin{itemize}
    ...
    \item \textbf{Definition 4.1.1} \emph{Transposition} \\
        The group of all permutations of the set $\{1,2,\ldots,n\}$, also known as bijections
        from $\{1,2,\ldots,n\}$ to itself, is denoted by $\mathfrak{S}_n$ and called the
